...
% Previous solution
files    = dir(['./soluciones/DYT-05-May-2021_Ib*_zeta1,2571e-05tau5,5194e-07nrA',num2str(nrA),'nzA',num2str(nzA),'nrB41nrC21nrE61nzE',num2str(nzE),'.mat']);
...
if Ib_feN0(fileid)/Nturns == Ib_fe
    return
else
    name_prev_sol = ['soluciones/DYT-05-May-2021_Ib',num2str(Ib_feN0(fileid)),...
...
%         dd0zD, dd0zzD,ZminD,ZmaxD,RminD,RmaxD)
    ...
    if ksave==1 && filesave ==1
        clear a b
        % Case name
        finame = ['soluciones/DYT-',date,'_Ib' po2com(Ib) '_zeta' po2com(zeta),...
            'tau' po2com(tau) 'nrA' num2str(nrA)     'nzA' num2str(nzA)  'nrB' ...
            num2str(nrB) 'nrC' num2str(nrC) 'nrE' num2str(nrE)    'nzE' num2str(nzE) '.mat'];
