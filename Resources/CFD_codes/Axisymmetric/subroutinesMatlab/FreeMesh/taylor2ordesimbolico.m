...
%  tic
%  matlabFunction(dux,duy,duxx,duyy,'file','eigen/jacobians3D/taylorN6.m','vars',{va,x1r,y1r,x2r,y2r,x1ry1r,A});
%  toc
%  
 tic
 %collocation matrix
% matlabFunction(duxva,duyva,duxxva,duyyva,'file','eigen/jacobians3D/collocationN7a.m','vars',{x1r,y1r,x2r,y2r,x1ry1r,A},'Optimize',false);
 matlabFunction(duxva,duyva,duxxva,duyyva,'file','collocationtalylorN6.m','vars',{x1r,y1r,x2r,y2r,x1ry1r,A});
