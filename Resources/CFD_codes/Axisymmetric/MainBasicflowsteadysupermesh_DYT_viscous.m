...
% Geometry
% Block A (Ferrofluid)
R     = 0.05; % Radius of the container
...
eta_fe   = 50*1.445/1000;  % Dynamic viscosity (Ns/m2 or Pa·s)
...
name_prev_sol = './soluciones2/JAM-10-May-2021_Ib0_zeta1,2571e-05tau5,5194e-07nrA101nzA101nrB41nrC21nrE61nzE101_t9.9.mat';
...
if (leq==1)
    ...
    %phisical properties of the liquid
...
%         dd0zD, dd0zzD,ZminD,ZmaxD,RminD,RmaxD)
    ...
    if ksave==1 && filesave ==1
        clear a b
        % Case name
        finame = ['soluciones2/JAM-',date,'_Ib' po2com(Ib) '_zeta' po2com(zeta),...
