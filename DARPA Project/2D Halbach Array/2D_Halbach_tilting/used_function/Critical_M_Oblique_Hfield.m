function [Mc,M] = Critical_M_Oblique_Hfield(H0,Hx,parameters)
%CRITICAL_Moblique Calcultate Critical Magnetization and Magnetization of Ferrofluid at Interface.
...
%   This function takes H0 (H-field Magnitude) at the interface, Hx (tangential component of H -field) at the interface,
%   parameters composed with Gravitational
...
Mc      = sqrt(2/mu0*(1+1./r0).*(sqrt(g*d_rho*sigma)+mu0*(1-r0).^2/2./(1+r0).*Hx.^2));              % [A/m]
