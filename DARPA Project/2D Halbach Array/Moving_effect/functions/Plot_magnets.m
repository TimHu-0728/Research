function Plot_magnets(theta,w,h,r0,cover,quiverornot,ind,N_coil_inf)
%PLOT_MAGNETS Plot the magnets shape
...
%  r0    (Position vectors of magnets)                        [m]
...
if ind == (N_coil_inf/2+1)
    plot(xcord,ycord,'LineWidth',3,'Color','r')
else
