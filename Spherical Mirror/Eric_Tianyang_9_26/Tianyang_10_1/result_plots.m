function result_plots(x, r_flat, I, rz, N_count,parameters)
...
%     N_count         = 91;                                                                                 %numbers of sample points per axis
    ...
    %% Plot Magnetization (M) and Critical Magetization (Mc) along the suraface
    figure(7)
    [Mc,M]   = Critical_M(xx',yy',nx',ny',I,rz,parameters);
    plot(xx',Mc,'*',xx',M,'+',xx',parameters(4)*ones(N_count,1),'--','LineWidth',2,'MarkerSize',10)
