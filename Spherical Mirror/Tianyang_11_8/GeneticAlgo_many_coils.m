...
[rho_Chi0_cfit, gof1] = createFit_RhovsMs(chi0, rho);
[Ms_rho_cfit, gof2] = createFit_Ms_rho(rho, Ms);
...
Ms      = Ms_rho_cfit(rho);                                                  % Saturation Magnetization Found corresponding to chi0 [A/m]
...
opts.PopulationSize         = 18000; %200 by default, 802 is optimal (perfect case)
...
result_plots(x, r_flat, I, rz, N_count,parameters);  
