...
Ms_data   = [27.5 6.6  6.6  11   6.6  3.3  22   11   35.5  22   11   6.6];      % Saturation Magnetization [mT]
...
g       = 9.806%1e-6;%9.806;                                                             % Gravitational Acceleration [m/s^2]
...
opts.PopulationSize         = 6000; %200 by default, 802 is optimal (perfect case)
...
% Plotting
[actual_contour_x_coordinate, actual_contour_y_coordinate,PI_diff] = result_plots(x, r_flat, I, rz, N_count,parameters);                                                                             %This function was created to localize the plots somewhere other than the main code.
...
function [c,ceq] = nonlcon(y,parameters)
    ...
    I              = exp([y(2);y(5);y(8);y(11);y(14):y(17)]);
    co             = [y(4) y(3);y(7) y(6);y(10) y(9);y(13) y(12);y(16) y(15);y(19) y(18)];
    ...
    c(1:IN)=[y(3)-(30 - sqrt(900 - y(4) .^ 2));
             ...
             y(15)-(30 - sqrt(900 - y(16) .^ 2))
             y(18)-(30 - sqrt(900 - y(19) .^ 2))];
