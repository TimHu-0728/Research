function [Mc,M] = Critical_M(r,z,I,co,parameters)
...
%% Calculating Magnetic Field H0 Along the Interface
...
% syms H 
% H0      = double(vpasolve(mu0*(Ms*(coth(gamma*H)-1/gamma/H)+H)==B,H));                   % Magnetic field at the interface [A/m] (Assume the field is nearly normal to the surface)
